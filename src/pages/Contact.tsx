        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <Input
              ...
              required
              className="w-full border-2 border-gray-300 focus:border-red-400 focus:ring-0 focus:ring-offset-0 focus-visible:ring-0 focus-visible:ring-offset-0 rounded-lg"
            />
          </div>
          ...
          <div>
            <Textarea
              ...
              required
              rows={6}
              className="w-full border-2 border-gray-300 focus:border-red-400 focus:ring-0 focus:ring-offset-0 focus-visible:ring-0 focus-visible:ring-offset-0 rounded-lg resize-none"
            />
          </div>
